                ...
                if (link.isRoute) {
                  return (
                    ...
                    <Link
                      ...
                      className={`font-body text-base py-2 px-2 rounded-md transition-all ${isLinkActive(link.href) ? "text-golden bg-golden/20 border border-golden/40" : "text-foreground hover:text-primary hover:bg-muted/60"}`}
                    >
                      {link.label}
                    </Link>
                    </motion.div>
                ...
                if (isHome) {
                  return (
                    <motion.a
                      ...
                      className="font-body text-base text-foreground py-2 px-2 rounded-md hover:text-primary hover:bg-muted/60 transition-all"
                    >
                      {link.label}
                    </motion.a>
                  );
